$(document).ready(function(){
    ...
    $('.demo_apply').click(function() {
        ...
        var demo_settings = {
          ...
          'click_lay_s': ['1','1','1','1','1','1','1','1','1'],
          'click_lay_c': ['1','1','1','1','1','1','1','1','1'],
          'click_lay_a': ['1','1','1','1','1','1','1','1','1'],
          ...
          'ban_spa_home': ['2','1','2','3','1','3','1','2','1'],
          'ban_ts_home': ['60','110','0','0','30','80','30','0','0'],
          'ban_bs_home': ['30','0','30','0','0','80','0','30','40'],
          ...
          'nc_best_bot': ['40','0','0','0','0','20','0','0','0'],
          ...
          'nc_cc1_per': ['3','3','3','3','3','3','3','3','4'],
          'nc_cc1_spa': ['1','3','3','3','1','1','3','3','1'],
          'nc_cc1_slider': ['1','1','1','1','1','1','1','1','2'],
          ...
          'nc_cc1_bot': ['0','0','0','0','0','20','0','0','60'],
          ...
          'w_all': ['2','2','2','2','1','2','1','1','1'],
          'w_cat': ['2','2','2','2','1','2','1','1','1'],
          'w_pro': ['1','2','2','2','1','2','1','1','1'],
          'w_con': ['1','2','1','1','1','1','1','1','1'],
          'w_cart': ['1','2','1','2','1','1','1','1','1'],
          ...
          'pl_hover_trans': ['0','0.52','0','0','0','0','0','0','0.6'],
          ...
          'nc_pp_sep': ['1','1','1','1','1','1','1','1','1'],
          'nc_pp_con': ['1','2','1','3','2','1','2','1','1'],
          'nc_pp_i': ['1','2','1','2','1','1','2','1','1'],
          'nc_pp_add': ['1','2','1','2','1','1','2','1','1'],
          'pp_thumbs': ['2','2','2','2','2','2','2','2','2'],
          'pp_imgb': ['0','0','0','0','1','1','0','0','1'],
          'pp_imgspacing': ['1','1','1','1','1','1','1','1','1'],
          'nc_mobadots': ['1','1','1','1','1','1','1','1','1'],
          'pp_sticky': ['1','1','2','1','2','1','1','2','1'],
          ...
          'footer_lay': ['6','5','3','3','7','7','4','5','2'],
          'nc_footer_w': ['2','1','1','1','1','2','1','1','1'],
          ...
          'f_headings': ['Poppins','Poppins','Poppins','Poppins','Poppins','Josefin Sans','Judson','Lobster Two','Noticia Text'],
          'f_buttons': ['Poppins','Poppins','Poppins','Poppins','Poppins','Josefin Sans','Circe','PT Sans','Noticia Text'],
          'f_text': ['Poppins','Poppins','Poppins','Poppins','Poppins','Josefin Sans','Circe','PT Sans','Noticia Text'],
          'f_price': ['Poppins','Poppins','Poppins','Poppins','Poppins','Josefin Sans','Circe','PT Sans','Noticia Text'],
          'f_menu': ['Poppins','Poppins','Poppins','Poppins','Poppins','Josefin Sans','Circe','PT Sans','Noticia Text'],
          'f_pn': ['Poppins','Poppins','Poppins','Poppins','Poppins','Josefin Sans','Circe','PT Sans','Noticia Text'],
    ...
    $('.colors_apply').click(function() {
        ...
        var scheme_colors = {
                  ...
                  'pl_hover_g1': ['#f2f2f2','#272727','#f2f2f2','#f2f2f2','#f2f2f2','#f2f2f2','#f1dfdd','#f2f2f2','#439079'],
                  'pl_hover_g2': ['#d1d1d1','#272727','#d1d1d1','#d1d1d1','#d1d1d1','#d1d1d1','#f1dfdd','#d1d1d1','#337964'],
