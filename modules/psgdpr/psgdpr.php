...
class Psgdpr extends Module
{
    ...
    private $presetMessageAccountCreation = array(
        ...
        'ru' => 'Я соглашаюсь на обработку указанных мною персональных данных в соответствии с <a target="_blank" href="/content/2-privacy-policy">политикой конфиденциальности</a>.'
    );
