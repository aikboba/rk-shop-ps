...
class CDEKConf
{
    ...
    public static function  getAddService(){
	    If (ConfSK::getConf('AddService') == 1){
	        return 37;
        }
        return false;
}
    ...
    {
        return ConfSK::getConf('company');
    }

    public static function getName()
    {
        return ConfSK::getConf('name');
    }

    public static function getAddress()
    {
        return ConfSK::getConf('address');
    }

    public static function getStreet()
    {
        return ConfSK::getConf('street');
    }

    public static function getHouse()
    {
        return ConfSK::getConf('house');
    }
    public static function getFlat()
    {
        return ConfSK::getConf('flat');
    }

    public static function getPhone()
    {
        return ConfSK::getConf('phone');
    }

    public static function getStart_time()
    {
        return ConfSK::getConf('start_time');
    }

    public static function getEnd_time()
    {
        return ConfSK::getConf('end_time');
    }
