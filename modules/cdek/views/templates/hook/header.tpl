...
<script type="text/javascript">
    ...
    var cdek_order_info = {
        date: "{if $cdek_order_info->delivery_date && $cdek_order_info->delivery_date != '0000-00-00 00:00:00' && $cdek_order_info->delivery_date != '0000-00-00'}{date('Y-m-d', strtotime($cdek_order_info->delivery_date))|escape:'quotes':'UTF-8'}{else}00-00-0000{/if}",
...
<script type="text/html" id="cdek_pvz_list_item">
    <div class="cdek_pvz_list_item %active%" data-delivery-point="%city%, %address%" data-code="%code%" daat>
        <div class="cdek_info">
            ...
            <div class="cdek_item_info">{l s='Item selected' mod='cdek'}</div>
        </div>
        {*{include file="./delivery_time.tpl" time_option=true}*}
    </div>
</script>