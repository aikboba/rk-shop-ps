  ...
  <div class="delivery-options-list">
    {if $delivery_options|count}
      <form
        ...
        method="post"
      >
          <h4>Чтобы предотвратить распространение COVID-19, мы рекомендуем:</h4>
          ...
          <h6>• соблюдать дистанцию в очереди от 1,5 м. Кроме того, сейчас в офисе могут находиться не более 2 клиентов одновременно.</h6>
          <h5>Каждые 2 часа мы дезинфицируем все поверхности в пунктах выдачи.</h5>
          <h5>На этой неделе временно закрыты ТРЦ. Поэтому мы, к сожалению, приостановили работу пунктов выдачи, которые находятся на территории торговых центров.</h5>
          <h5>Сейчас закрыты более 50 офисов СДЭК. Проверить, работает ли пункт выдачи, можно в личном кабинете, по интеграции, на сайте <a href="https://cdek.ru">
                  {l s='cdek.ru' d='Shop.Theme.Customeraccount'}
